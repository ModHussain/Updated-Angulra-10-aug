		...
		adddata: function(postrequirement){
			...
			//RA dashboard start
	   		...
	   		RAtotalResourceByTechnology: function(){
				var deferred = $q.defer();
				$http.get('rest/resource/totalResourceByTechnology/').success(function(response){
						deferred.resolve(response);
				}).error(function(err){
					deferred.reject(err);
				})
	   		...
	   		//Top  customers by requirements
				...
				var deferred = $q.defer();
				$http.get('https://api.myjson.com/bins/avtqg').success(function(response){
						deferred.resolve(response);
				}).error(function(err){
					deferred.reject(err);
				})
	   		...
	   		//Top Vendors By Resource
	   		  ...
	   		  RAToptenVendors: function(){
					var deferred = $q.defer();
					$http.get('https://api.myjson.com/bins/70iaw').success(function(response){
							deferred.resolve(response);
					}).error(function(err){
						deferred.reject(err);
					})
	   		...
	   		//Total resources by technology in cities
		   	  ...
		   	  Ratencities: function(){
					var deferred = $q.defer();
					$http.get('rest/resource/resourcesByCityAndTechnology').success(function(response){
							deferred.resolve(response);
					}).error(function(err){
						deferred.reject(err);
					})
		   		...
		   		RArequirementTechnology: function(){
						var deferred = $q.defer();
						$http.get('https://api.myjson.com/bins/194wxs').success(function(response){
								deferred.resolve(response);
						}).error(function(err){
							deferred.reject(err);
						})
			   		...
			   		RArequirementCities: function(){
						var deferred = $q.defer();
						$http.get('rest/requirement/requirementsByJobLocation').success(function(response){
								deferred.resolve(response);
						}).error(function(err){
							deferred.reject(err);
						})
			   		...
			   		RATopTech: function(){
						var deferred = $q.defer();
						$http.get('https://api.myjson.com/bins/sh0hk').success(function(response){
								deferred.resolve(response);
						}).error(function(err){
							deferred.reject(err);
						})
...
//			},
			...
			vendorgetRegistrationById: function(id){
	   		...
	   		//Total resources by technology in cities
		   	  ...
		   	  tencities: function(){
					var deferred = $q.defer();
					$http.get('https://api.myjson.com/bins/e7mr2').success(function(response){
							deferred.resolve(response);
					}).error(function(err){
						deferred.reject(err);
					})
		   		...
		   		requirementTechnology: function(){
			   		...
			   		requirementCities: function(){
						var deferred = $q.defer();
						$http.get('https://api.myjson.com/bins/1ar0rc').success(function(response){
								deferred.resolve(response);
						}).error(function(err){
							deferred.reject(err);
						})
			   		...
			   		ReqVsPro: function(){
						var deferred = $q.defer();
						$http.get('https://api.myjson.com/bins/154imw').success(function(response){
								deferred.resolve(response);
						}).error(function(err){
							deferred.reject(err);
						})
			   		...
			   		ReqVsClo: function(){
						var deferred = $q.defer();
						$http.get('https://api.myjson.com/bins/jxtx8').success(function(response){
								deferred.resolve(response);
						}).error(function(err){
							deferred.reject(err);
						})
